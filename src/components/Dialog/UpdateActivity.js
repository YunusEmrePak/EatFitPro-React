    ...
    const submitHandler = async (event) => {
      ...
      if (!errorHandler()) {
        const data = {
          ...
          activityCategory: {
            id: category ? category.id : context.updatingItem.activityCategoryDto.id,
          },
        };
        console.log(data);
              ...
              <Autocomplete
                ...
                value={
                  category
                    ...
                    ? {
                        id: context.updatingItem.activityCategoryDto.id,
                        name: context.updatingItem.activityCategoryDto.name,
                      }
                    : null
                }
                renderInput={(params) => (
